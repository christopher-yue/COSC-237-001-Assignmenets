public class OrderedArrayList extends ArrayListClass{
    ...
    public OrderedArrayList merge(OrderedArrayList otherList){
        OrderedArrayList result = new OrderedArrayList(length + otherList.length);
        int i = 0;
        int j = 0;
        int x = 0;
        ...
        if(length < otherList.length){
            while(i < length && j < otherList.length){
                ...
                else if(otherList.list[j] < list[i]){
                    result.list[x] = otherList.list[j];
                    x++;
                    j++;
                }
                result.length++;
        ...
        else if(otherList.length < length){
            while(i < length && j < otherList.length){
                if(list[i] < otherList.list[j]){
                    result.list[x] = list[i];
                    x++;
